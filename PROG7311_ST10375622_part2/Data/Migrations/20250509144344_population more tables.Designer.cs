...
namespace PROG7311_ST10375622_part2.Data.Migrations
{
    ...
    [Migration("20250509144344_population more tables")]
    partial class populationmoretables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PROG7311_ST10375622_part2.Models.Comments", b =>
                {
            ...
            modelBuilder.Entity("PROG7311_ST10375622_part2.Models.Farmer", b =>
                {
                    b.Property<int>("FarmerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TypeOfFarmer")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PROG7311_ST10375622_part2.Models.Post", b =>
                {
                    b.Property<int>("PostId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PROG7311_ST10375622_part2.Models.Comments", b =>
                {
                    b.HasOne("PROG7311_ST10375622_part2.Models.Farmer", "Farmer")
                        .WithMany()
                        .HasForeignKey("FarmerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PROG7311_ST10375622_part2.Models.Post", "Post")
                        .WithMany()
